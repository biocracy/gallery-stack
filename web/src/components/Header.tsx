            ...
            <div className="relative max-w-[1600px] mx-auto flex h-24 items-center justify-between px-6 sm:px-12">
                ...
                <div className="flex items-center gap-0 z-10">
                    <Link href="/" className="flex items-center gap-2">
                        {logoElement?.image ? (
                            <div className="relative h-20 w-60 mix-blend-multiply dark:mix-blend-screen dark:invert">
                                <Image
                    ...
                    <a
                        ...
                        className="hidden sm:block text-neutral-500 hover:text-black dark:text-neutral-400 dark:hover:text-white transition-colors -ml-12 relative z-20"
                    >
                        <svg
